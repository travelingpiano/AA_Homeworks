...
var GiphysIndex = function GiphysIndex(_ref) {
  ...
  return _react2.default.createElement(
    'ul',
    null,
    giphyslinks.map(function (giphy, idx) {
      return _react2.default.createElement(_giphys_index_item2.default, { key: idx, link: giphy });
    })
  );
};
...
var GiphysIndexItem = function GiphysIndexItem(_ref) {
  ...
  return _react2.default.createElement(
    "li",
    { className: "giphy-li" },
    _react2.default.createElement("img", { src: "" + link })
  );
};
